...
class Ui_MsiExportScilsDialog(object):
    def setupUi(self, MsiExportScilsDialog):
        ...
        MsiExportScilsDialog.resize(366, 193)
    ...
    def retranslateUi(self, MsiExportScilsDialog):
        MsiExportScilsDialog.setWindowTitle(QCoreApplication.translate("MsiExportScilsDialog", u"Export Cardinal HDF5", None))
        self.group_box_image_type.setTitle(QCoreApplication.translate("MsiExportScilsDialog", u"Images to export", None))
        self.radio_quant.setText(QCoreApplication.translate("MsiExportScilsDialog", u"Quantitative images", None))
        self.radio_iso.setText(QCoreApplication.translate("MsiExportScilsDialog", u"Isotope corrected images", None))
        self.radio_raw.setText(QCoreApplication.translate("MsiExportScilsDialog", u"Raw images", None))
#if QT_CONFIG(tooltip)
        self.include_summed_checkbox.setToolTip(QCoreApplication.translate("MsiExportScilsDialog", u"<html><head/><body><p>This wil include in the export the ion images that are created by summing the different adducts of the same species. These summed forms will be assigned the neutral mass for their m/z vlaue.</p></body></html>", None))
