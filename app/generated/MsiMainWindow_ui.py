...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scroll_area_raw_contents.setGeometry(QRect(0, 0, 319, 422))
        ...
        self.scroll_area_iso_contents.setGeometry(QRect(0, 0, 319, 422))
        ...
        self.scroll_area_quant_contents.setGeometry(QRect(0, 0, 319, 422))
